...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public function find_category($category_id)
	{
		...
		$this->loadmodel('categorie');
		@$result=$this->categorie->find('all',array('conditions'=>$conditions,'fields'=>array('categories')));
		return $result;
	}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public function find_subcategory($subcategory_id)
	{
		$conditions=array('id' => $subcategory_id);
		$this->loadmodel('sub_categorie');
		@$result=$this->sub_categorie->find('all',array('conditions'=>$conditions,'fields'=>array('sub_categories')));
		return $result;
	}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function mailchimp($template_name, $message, $template_content)
{
	...
	$mandrill->templates->add($template_name, 'Hello', 'Mail', $message);
