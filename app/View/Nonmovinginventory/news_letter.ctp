                ...
                foreach ($categories_arr as $categories_ftc) 
                {
                    $i++;
                      ...
                      $message_body.='<div class="item " style="padding:1%; float:left; width:31.33%; height:170px;">
                        ...
                        <a href="'.$show_img.$this->webroot.'Nonmovinginventory/categories_details?categories_id='.$categories_ftc['Categorie']['id'].'" style="text-decoration:none;"><img src="'.$show_img.$this->webroot.'images/icon_category/'.$categories_ftc['Categorie']['icon'].'" alt="NAME" style="height:100%; width:100%;" class="img-responsive">
