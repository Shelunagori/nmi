                ...
                foreach ($categories_arr as $categories_ftc) 
                {
                    $i++;
                      ...
                      $message_body.='<div class="item " style="padding:1%; float:left; width:31.33%; height:170px; position: relative;">
                        ...
                        <a href="'.$show_img.$this->webroot.'Nonmovinginventory/categories_details?categories_id='.$categories_ftc['Categorie']['id'].'" style="text-decoration:none;  text-transform: uppercase;  color: #FFF; background: rgba(100, 174, 217, 0.85) none repeat scroll 0% 0%;"><img src="'.$show_img.$this->webroot.'images/icon_category/'.$categories_ftc['Categorie']['icon'].'" alt="NAME" style="height:170px; width:98%; position: absolute; left: 0px; " class="img-responsive">
