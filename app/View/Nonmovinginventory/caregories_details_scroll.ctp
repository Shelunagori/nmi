        ...
        <div class="col-md-6 col-sm-12">
             <div class="portlet blue-hoki box">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i><a  style="color:#FFF" href="ads_details?post_id=<?php echo $classified_post_id; ?>" class="search-result-title  "  rel='tab'> <?php echo @$sub_categories; if(!empty($product_name)) { ?> ( <?php echo $product_name; ?> )<?php } ?></a>
                    </div>
                </div>
                        ...
                        <div class="portlet-body">
                                <div class="row static-info">
                                    <div class="col-md-12 value">
                                     ...
                                     <div class="col-sm-2">
                                     <a href="ads_details?post_id=<?php echo $classified_post_id; ?>" class="btn-block result-details-link"  rel='tab'>
