...
<link href="<?php echo $this->webroot; ?>theme_admin/assets/admin/layout2/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
<link href="<?php echo $this->webroot; ?>theme_admin/assets/admin/layout2/css/custom.css" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->
...
<body ng-controller="AppController" class="page-boxed page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-sidebar-closed-hide-logo page-on-load" ng-class="{'page-sidebar-closed': settings.layout.pageSidebarClosed}">
	...
	<script src="<?php echo $this->webroot; ?>theme_admin/assets/global/plugins/angularjs/angular.min.js" type="text/javascript"></script>	
	<script src="<?php echo $this->webroot; ?>theme_admin/assets/global/plugins/angularjs/angular-sanitize.min.js" type="text/javascript"></script>
	<script src="<?php echo $this->webroot; ?>theme_admin/assets/global/plugins/angularjs/angular-touch.min.js" type="text/javascript"></script>	
	<script src="<?php echo $this->webroot; ?>theme_admin/assets/global/plugins/angularjs/plugins/angular-ui-router.min.js" type="text/javascript"></script>
	<script src="<?php echo $this->webroot; ?>theme_admin/assets/global/plugins/angularjs/plugins/ocLazyLoad.min.js" type="text/javascript"></script>
	<script src="<?php echo $this->webroot; ?>theme_admin/assets/global/plugins/angularjs/plugins/ui-bootstrap-tpls.min.js" type="text/javascript"></script>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {   
			...
			Metronic.setAssetsPath('<?php echo $this->webroot; ?>theme_admin/assets/'); // Set the assets folder path			
		});
	</script>
	<!-- END JAVASCRIPTS -->
</body>
